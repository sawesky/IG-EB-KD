...
# Final CIFAR-100 WRN KD settings from the previous multi-seed benchmark runner.
BEST_KD_T = 1.0
BEST_KD_LAMBDA = 0.8

OUT_PATH = Path(
    "results/head_metric/rho_sweeps/"
    "hifar_wrn_teacher_fisher_rho_sweep_summary.csv"
)
...
def summarize_run(rho, metrics_path):
    ...
    # Hyperparameter selection is based only on validation NLL.
...
def print_summary(rows):
    print("\nCIFAR-100 WRN TEACHER-INDUCED FISHER RHO SWEEP SUMMARY")
    print(
...
def save_summary(rows):
    ...
    print(f"\nsaved Teacher-induced rho sweep summary: {OUT_PATH}")
...
def main():
    ...
    for rho in RHOS:
        ...
        # Fixed best KD baseline from the previous CIFAR-100 WRN benchmark.
        ...
        print("\n" + "=" * 80)
        print(
            "Running CIFAR-100 WRN Teacher-induced Fisher rho sweep: "
