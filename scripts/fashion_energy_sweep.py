...
BASE_CONFIG = "configs/fashion_student_kd_energy.yaml"
BETAS = [0.001, 0.005, 0.01, 0.03, 0.05, 0.1]
OUT_PATH = Path("results/fashion_energy_sweep_summary.csv")
...
def print_summary(rows):
    columns = [
        "beta", "best_epoch", "best_val_acc", "best_val_nll", "best_val_ece",
        "best_val_energy_mismatch", "test_acc", "test_nll", "test_ece", "test_energy_mismatch",
    ]
    widths = {
        "beta": 10, "best_epoch": 10, "best_val_acc": 14, "best_val_nll": 14,
        "best_val_ece": 14, "best_val_energy_mismatch": 24, "test_acc": 10,
        "test_nll": 10, "test_ece": 10, "test_energy_mismatch": 22,
    }
    print("\nFASHION ENERGY SWEEP SUMMARY")
...
def save_summary(rows):
    ...
    fieldnames = [
        "beta", "metrics_path", "best_epoch", "best_val_acc", "best_val_nll", "best_val_ece",
    ...
    print(f"\nsaved Fashion Energy sweep summary: {OUT_PATH}")
...
def main():
    ...
    for beta in BETAS:
        ...
        name = f"fashion_student_kd_energy_b{value_to_name(beta)}"
        ...
        print("\n" + "=" * 80)
        print(f"Running Fashion Energy sweep: beta={beta}")
        print("=" * 80)
    ...
    print(
        ...
        f"beta={best_nll['beta']:g}, val_nll={best_nll['best_val_nll']:.6f}, "
        f"test_nll={best_nll['test_nll']:.6f}, test_acc={best_nll['test_acc']:.6f}"
    )
    print(
        "Best by validation Energy mismatch: "
        f"beta={best_energy['beta']:g}, val_energy={best_energy['best_val_energy_mismatch']:.6f}, "
        f"test_energy={best_energy['test_energy_mismatch']:.6f}, test_nll={best_energy['test_nll']:.6f}"
    )
