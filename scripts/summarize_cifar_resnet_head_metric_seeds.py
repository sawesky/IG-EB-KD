...
OUT_PATH = Path("results/head_metric/cifar_resnet_head_metric_seeds_summary.csv")
    ...
    return [
        {
            ...
            "rho": 0.0,
            "base_name": "cifar_resnet20_kd_head_euclidean",
        },
        {
            "method": "ResNet-20 KD + Student-Fisher",
            "rho": student_rho,
            "base_name": (
        ...
        {
            "method": "ResNet-20 KD + Teacher-induced Fisher",
            "rho": teacher_rho,
            "base_name": (
...
def main():
    ...
    print("\nCIFAR-10 ResNet head-metric multi-seed summary")
