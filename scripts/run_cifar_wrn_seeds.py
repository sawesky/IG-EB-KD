...
RUNS = [
    {
        "method": "WRN-16-2 CE",
        "base_config": "configs/cifar_wrn_student_ce.yaml",
        "name": "cifar_wrn16_2_student_ce",
        "kd": None,
        "extensions": None,
    },
    {
        "method": "WRN-16-2 KD",
        "base_config": "configs/cifar_wrn_student_kd.yaml",
        "name": "cifar_wrn16_2_student_kd",
        "kd": {"temperature": 1.5, "lambda_kd": 0.8},
        "extensions": {
            "fisher_alpha": 0.0,
            "energy_beta": 0.0,
    ...
    },
    {
        ...
        "name": "cifar_wrn16_2_student_kd_fisher",
        "kd": {"temperature": 1.5, "lambda_kd": 0.8},
        "extensions": {
            "fisher_alpha": 0.01,
            "energy_beta": 0.0,
    ...
    },
    {
        ...
        "name": "cifar_wrn16_2_student_kd_energy",
        "kd": {"temperature": 1.5, "lambda_kd": 0.8},
        "extensions": {
            "fisher_alpha": 0.0,
            "energy_beta": 0.0005,
    ...
    },
    {
        ...
        "base_config": "configs/cifar_wrn_student_kd_fisher_energy.yaml",
        "name": "cifar_wrn16_2_student_kd_fisher_energy",
        "kd": {"temperature": 1.5, "lambda_kd": 0.8},
        "extensions": {
            "fisher_alpha": 0.01,
            "energy_beta": 0.0005,
...
def main():
    ...
    print("\nFinal WRN CIFAR-10 multi-seed runs finished.")
