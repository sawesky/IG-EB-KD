...
BASE_CONFIG = "configs/cifar_student_kd_energy.yaml"
BETAS = [0.001, 0.005, 0.01, 0.05, 0.1, 0.5]
OUT_PATH = Path("results/cifar_energy_sweep_summary.csv")
...
def save_summary(rows):
    ...
    print(f"\nsaved CIFAR Energy sweep summary: {OUT_PATH}")
...
def main():
    ...
    for beta in BETAS:
        ...
        name = f"cifar_student_kd_energy_b{value_to_name(beta)}"
        ...
        print("\n" + "=" * 80)
        print(f"Running CIFAR Energy sweep: beta={beta}")
        print("=" * 80)
