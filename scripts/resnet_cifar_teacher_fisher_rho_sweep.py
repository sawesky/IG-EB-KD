...
OUT_PATH = Path(
    ...
    "cifar_resnet_teacher_fisher_rho_sweep_summary.csv"
)
...
def print_summary(rows):
    print("\nCIFAR-10 RESNET TEACHER-INDUCED FISHER RHO SWEEP SUMMARY")
    print(
...
def main():
    ...
    for rho in RHOS:
        ...
        print("\n" + "=" * 80)
        print(
            "Running CIFAR-10 ResNet Teacher-induced Fisher rho sweep: "
