...
BASE_CONFIG = "configs/cifar_student_kd.yaml"
...
def save_summary(summary_rows):
    out_path = Path("results/cifar_kd_sweep_summary.csv")
...
def main():
    ...
    for T in TEMPERATURES:
        for lam in LAMBDAS:
            ...
            name = f"cifar_student_kd_T{value_to_name(T)}_l{value_to_name(lam)}"
