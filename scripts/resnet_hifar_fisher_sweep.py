...
BASE_CONFIG = "configs/hifar_resnet_student_kd_fisher.yaml"
...
OUT_PATH = Path("results/hifar_resnet_fisher_sweep_summary.csv")
...
def print_summary(rows):
    ...
    print("\nHIFAR / CIFAR-100 RESNET FISHER SWEEP SUMMARY")
...
def save_summary(rows):
    ...
    print(f"\nsaved HIFAR ResNet Fisher sweep summary: {OUT_PATH}")
...
def main():
    ...
    for alpha in ALPHAS:
        ...
        # Fixed best KD baseline from HIFAR KD sweep.
        ...
        print("\n" + "=" * 80)
        print(
            f"Running HIFAR ResNet Fisher sweep: "
            f"T={BEST_KD_T}, lambda={BEST_KD_LAMBDA}, alpha={alpha}"
        )
        print("=" * 80)
