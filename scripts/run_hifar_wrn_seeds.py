...
RUNS = [
    {
        "method": "WRN-16-2 CE",
        "base_config": "configs/hifar_wrn_student_ce.yaml",
        "name": "hifar_wrn16_2_student_ce",
        "kd": None,
        "extensions": None,
    },
    {
        ...
        "name": "hifar_wrn16_2_student_kd",
        "kd": {"temperature": 1.0, "lambda_kd": 0.8},
        "extensions": {
            "fisher_alpha": 0.0,
            "energy_beta": 0.0,
    ...
    {
        "method": "WRN-16-2 KD + Fisher",
        "base_config": "configs/hifar_wrn_student_kd_fisher.yaml",
        "name": "hifar_wrn16_2_student_kd_fisher",
        "kd": {"temperature": 1.0, "lambda_kd": 0.8},
        "extensions": {
            "fisher_alpha": 0.01,
            "energy_beta": 0.0,
    ...
    {
        "method": "WRN-16-2 KD + Energy",
        "base_config": "configs/hifar_wrn_student_kd_energy.yaml",
        "name": "hifar_wrn16_2_student_kd_energy",
        "kd": {"temperature": 1.0, "lambda_kd": 0.8},
        "extensions": {
            "fisher_alpha": 0.0,
            "energy_beta": 0.05,
    ...
    {
        "method": "WRN-16-2 KD + Fisher + Energy",
        "base_config": "configs/hifar_wrn_student_kd_fisher_energy.yaml",
        "name": "hifar_wrn16_2_student_kd_fisher_energy",
        "kd": {"temperature": 1.0, "lambda_kd": 0.8},
        "extensions": {
            "fisher_alpha": 0.01,
            "energy_beta": 0.05,
...
def main():
    ...
    print("\nFinal HIFAR / CIFAR-100 WRN multi-seed runs finished.")
