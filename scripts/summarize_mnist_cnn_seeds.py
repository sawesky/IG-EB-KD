...
TEACHER_PATH = Path("results/mnist_teacher.csv")

RUNS = [
    ("LeNet CE", "mnist_student_ce"),
    ("LeNet KD", "mnist_student_kd"),
    ("LeNet KD + Fisher", "mnist_student_kd_fisher"),
    ("LeNet KD + Energy", "mnist_student_kd_energy"),
    ("LeNet KD + Fisher + Energy", "mnist_student_kd_fisher_energy"),
]

RESULT_DIR = Path("results/seeds")
OUT_PATH = Path("results/mnist_seeds_summary.csv")
...
def main():
    ...
    print("\nMNIST LeNet multi-seed summary")
