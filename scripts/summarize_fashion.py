...
RUNS = [
    ("T", "results/fashion_teacher.csv"),
    ("CE", "results/fashion_student_ce.csv"),
    ("KD", "results/fashion_student_kd.csv"),
    ("KD + Fisher", "results/fashion_student_kd_fisher.csv"),
    ("KD + Energy", "results/fashion_student_kd_energy.csv"),
    ("KD + Fisher + Energy", "results/fashion_student_kd_fisher_energy.csv"),
]


SUMMARY_PATH = Path("results/fashion_summary.csv")
