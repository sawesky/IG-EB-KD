...
OUT_PATH = Path(
    ...
    "cifar_wrn_alternating_final_seeds_summary.csv"
)
    ...
    return [
        {
            ...
            "rho": 0.0,
            "base_name": "cifar_wrn16_2_kd_head_euclidean_alternating",
        },
        {
            "method": "WRN-16-2 KD + Student-Fisher [alternating]",
            "rho": student_rho,
            "base_name": (
                "cifar_wrn16_2_kd_head_student_fisher_"
        ...
        },
        {
            ...
            "rho": teacher_rho,
            "base_name": (
                "cifar_wrn16_2_kd_head_teacher_fisher_"
...
def main():
    ...
    print("\nCIFAR-10 WRN alternating final five-seed summary")
