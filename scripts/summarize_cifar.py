...
RUNS = [
    ("T", "results/cifar_teacher.csv"),
    ("CE", "results/cifar_student_ce.csv"),
    ("KD", "results/cifar_student_kd.csv"),
    ("KD + Fisher", "results/cifar_student_kd_fisher.csv"),
    ("KD + Energy", "results/cifar_student_kd_energy.csv"),
    ("KD + Fisher + Energy", "results/cifar_student_kd_fisher_energy.csv"),
]

SUMMARY_PATH = Path("results/cifar_summary.csv")
