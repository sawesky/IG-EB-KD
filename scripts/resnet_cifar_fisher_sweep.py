...
OUT_PATH = Path("results/cifar_resnet_fisher_sweep_summary.csv")
...
def print_summary(rows):
    ...
    print("\nCIFAR-10 RESNET FISHER SWEEP SUMMARY")
...
def save_summary(rows):
    ...
    print(f"\nsaved CIFAR-10 ResNet Fisher sweep summary: {OUT_PATH}")
...
def main():
    ...
    for alpha in ALPHAS:
        ...
        name = f"cifar_resnet20_kd_fisher_T{value_to_name(BEST_KD_T)}_l{value_to_name(BEST_KD_LAMBDA)}_a{value_to_name(alpha)}"
        ...
        print("\n" + "=" * 80)
        print(
            f"Running CIFAR-10 ResNet Fisher sweep: "
