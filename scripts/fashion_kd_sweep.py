...
BASE_CONFIG = "configs/fashion_student_kd.yaml"
...
def save_summary(summary_rows):
    out_path = Path("results/fashion_kd_sweep_summary.csv")
...
def main():
    ...
    for T in TEMPERATURES:
        for lam in LAMBDAS:
            ...
            name = f"fashion_student_kd_T{value_to_name(T)}_l{value_to_name(lam)}"
            ...
            print("\n" + "=" * 80)
            print(f"Running KD sweep: T={T}, lambda={lam}")
            print("=" * 80)
