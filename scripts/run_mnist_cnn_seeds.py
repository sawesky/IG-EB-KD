...
RUNS = [
    {
        "method": "LeNet CE",
        "base_config": "configs/mnist_student_ce.yaml",
        "name": "mnist_student_ce",
        "kd": None,
        "extensions": None,
    },
    {
        ...
        "name": "mnist_student_kd",
        "kd": {"temperature": 3.0, "lambda_kd": 0.2},
        "extensions": {
            "fisher_alpha": 0.0,
            "energy_beta": 0.0,
    ...
    {
        "method": "LeNet KD + Fisher",
        "base_config": "configs/mnist_student_kd_fisher.yaml",
        "name": "mnist_student_kd_fisher",
        "kd": {"temperature": 3.0, "lambda_kd": 0.2},
        "extensions": {
            "fisher_alpha": 0.1,
            "energy_beta": 0.0,
    ...
    {
        "method": "LeNet KD + Energy",
        "base_config": "configs/mnist_student_kd_energy.yaml",
        "name": "mnist_student_kd_energy",
        "kd": {"temperature": 3.0, "lambda_kd": 0.2},
        "extensions": {
            "fisher_alpha": 0.0,
            "energy_beta": 0.01,
    ...
    {
        "method": "LeNet KD + Fisher + Energy",
        "base_config": "configs/mnist_student_kd_fisher_energy.yaml",
        "name": "mnist_student_kd_fisher_energy",
        "kd": {"temperature": 3.0, "lambda_kd": 0.2},
        "extensions": {
            "fisher_alpha": 0.1,
            "energy_beta": 0.01,
...
def main():
    ...
    print("\nFinal MNIST LeNet multi-seed runs finished.")
