...
TEACHER_PATH = Path("results/cifar_wrn40_2_teacher.csv")

RUNS = [
    ("WRN-16-2 CE", "cifar_wrn16_2_student_ce"),
    ("WRN-16-2 KD", "cifar_wrn16_2_student_kd"),
    ("WRN-16-2 KD + Fisher", "cifar_wrn16_2_student_kd_fisher"),
    ("WRN-16-2 KD + Energy", "cifar_wrn16_2_student_kd_energy"),
    ("WRN-16-2 KD + Fisher + Energy", "cifar_wrn16_2_student_kd_fisher_energy"),
]

RESULT_DIR = Path("results/seeds")
OUT_PATH = Path("results/cifar_wrn_seeds_summary.csv")
...
def main():
    ...
    print("\nCIFAR-10 WRN multi-seed summary")
