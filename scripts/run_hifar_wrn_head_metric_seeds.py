    ...
    return [
        {
            ...
            "name": "hifar_wrn16_2_kd_head_euclidean",
        ...
        {
            "method": f"WRN-16-2 KD + Student-Fisher (rho={student_rho:g})",
            "name": (
        ...
        {
            "method": (
                "WRN-16-2 KD + Teacher-induced Fisher "
                f"(rho={teacher_rho:g})"
            ),
            "name": (
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Run final 5-seed CIFAR-100 WRN head-geometry experiments after "
    ...
    for seed in SEEDS:
        for run in runs:
            ...
            # Fixed best KD baseline from the previous CIFAR-100 WRN runs.
    ...
    print("\nFinal CIFAR-100 WRN head-metric 5-seed runs finished.")
    print(
        "Summarize with:\n"
        "python scripts/summarize_hifar_wrn_head_metric_seeds.py "
