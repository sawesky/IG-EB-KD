...
RUNS = [
    {
        "method": "ResNet-20 CE",
        "base_config": "configs/hifar_resnet_student_ce.yaml",
        "name": "hifar_resnet20_student_ce",
        "kd": None,
        "extensions": None,
    },
    {
        ...
        "name": "hifar_resnet20_student_kd",
        "kd": {"temperature": 1.0, "lambda_kd": 0.7},
        "extensions": {
            "fisher_alpha": 0.0,
            "energy_beta": 0.0,
    ...
    },
    {
        ...
        "name": "hifar_resnet20_student_kd_fisher",
        "kd": {"temperature": 1.0, "lambda_kd": 0.7},
        "extensions": {
            "fisher_alpha": 0.001,
            "energy_beta": 0.0,
    ...
    },
    {
        ...
        "base_config": "configs/hifar_resnet_student_kd_energy.yaml",
        "name": "hifar_resnet20_student_kd_energy",
        "kd": {"temperature": 1.0, "lambda_kd": 0.7},
        "extensions": {
            "fisher_alpha": 0.0,
            "energy_beta": 0.05,
    ...
    },
    {
        ...
        "base_config": "configs/hifar_resnet_student_kd_fisher_energy.yaml",
        "name": "hifar_resnet20_student_kd_fisher_energy",
        "kd": {"temperature": 1.0, "lambda_kd": 0.7},
        "extensions": {
            "fisher_alpha": 0.001,
            "energy_beta": 0.05,
...
def main():
    ...
    for seed in SEEDS:
        for run in RUNS:
            ...
            # Harmless bookkeeping. train.py uses cfg["seed"] directly,
            # but keeping these makes generated configs explicit.
            if "data" not in cfg:
                cfg["data"] = {}
            cfg["data"]["seed"] = seed
    ...
    print("\nFinal HIFAR / CIFAR-100 ResNet multi-seed runs finished.")
