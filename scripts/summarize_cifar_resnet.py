...
RUNS = [
    ("ResNet-56 teacher", "results/cifar_resnet56_teacher.csv"),
    ("ResNet-20 CE", "results/cifar_resnet20_student_ce.csv"),
    ("ResNet-20 KD", "results/cifar_resnet20_student_kd.csv"),
    ("ResNet-20 KD + Fisher", "results/cifar_resnet20_student_kd_fisher.csv"),
    ("ResNet-20 KD + Energy", "results/cifar_resnet20_student_kd_energy.csv"),
    ("ResNet-20 KD + Fisher + Energy", "results/cifar_resnet20_student_kd_fisher_energy.csv"),
]
SUMMARY_PATH = Path("results/cifar_resnet_summary.csv")
