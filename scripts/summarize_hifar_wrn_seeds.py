...
TEACHER_PATH = Path("results/hifar_wrn40_2_teacher.csv")

RUNS = [
    ("WRN-16-2 CE", "hifar_wrn16_2_student_ce"),
    ("WRN-16-2 KD", "hifar_wrn16_2_student_kd"),
    ("WRN-16-2 KD + Fisher", "hifar_wrn16_2_student_kd_fisher"),
    ("WRN-16-2 KD + Energy", "hifar_wrn16_2_student_kd_energy"),
    ("WRN-16-2 KD + Fisher + Energy", "hifar_wrn16_2_student_kd_fisher_energy"),
]

RESULT_DIR = Path("results/seeds")
OUT_PATH = Path("results/hifar_wrn_seeds_summary.csv")
...
def main():
    ...
    print("\nHIFAR / CIFAR-100 WRN multi-seed summary")
