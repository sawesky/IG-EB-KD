...
BASE_CONFIG = "configs/hifar_wrn_student_kd_energy.yaml"
...
OUT_PATH = Path("results/hifar_wrn_energy_sweep_summary.csv")
...
def print_summary(rows):
    ...
    print("\nHIFAR / CIFAR-100 WRN ENERGY SWEEP SUMMARY")
    header = " | ".join(
...
def save_summary(rows):
    ...
    print(
        f"\nsaved HIFAR WRN Energy sweep summary: "
        f"{OUT_PATH}"
    )
...
def main():
    ...
    for beta in BETAS:
        ...
        print("\n" + "=" * 80)
        print(
            f"Running HIFAR WRN Energy sweep: "
            f"T={BEST_KD_T}, "
    ...
    print(
        ...
        f"val_energy="
        f"{best_energy['best_val_energy_mismatch']:.6f}, "
        f"test_energy="
        f"{best_energy['test_energy_mismatch']:.6f}, "
