...
OUT_PATH = Path("results/mnist_fisher_sweep_summary.csv")
...
def summarize_run(alpha, metrics_path):
    ...
    return {
        ...
        "best_val_fisher_mismatch": get_float(
            best_val_row, "val_fisher_mismatch"
        ),
        "best_val_energy_mismatch": get_float(
            best_val_row, "val_energy_mismatch"
        ),
        ...
        "test_fisher_mismatch": get_float(
            test_row, "test_fisher_mismatch"
        ),
        "test_energy_mismatch": get_float(
            test_row, "test_energy_mismatch"
        ),
    }
...
def print_summary(rows):
    ...
    print("\nMNIST LENET FISHER SWEEP SUMMARY")
...
def save_summary(rows):
    ...
    print(f"\nsaved MNIST Fisher sweep summary: {OUT_PATH}")
...
def main():
    ...
    for alpha in ALPHAS:
        ...
        # Fixed best KD baseline from the MNIST KD sweep.
        ...
        print("\n" + "=" * 80)
        print(
            f"Running MNIST LeNet Fisher sweep: "
            f"T={BEST_KD_T}, "
        ...
        summary_rows.append(
            summarize_run(alpha, cfg["save"]["metrics_path"])
        )
