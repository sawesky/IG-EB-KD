...
OUT_PATH = Path("results/hifar_resnet_energy_sweep_summary.csv")
...
def print_summary(rows):
    ...
    print("\nHIFAR / CIFAR-100 RESNET ENERGY SWEEP SUMMARY")
...
def save_summary(rows):
    ...
    print(f"\nsaved HIFAR ResNet Energy sweep summary: {OUT_PATH}")
...
def main():
    ...
    for beta in BETAS:
        ...
        print("\n" + "=" * 80)
        print(
            f"Running HIFAR ResNet Energy sweep: "
