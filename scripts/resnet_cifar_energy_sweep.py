...
OUT_PATH = Path("results/cifar_resnet_energy_sweep_summary.csv")
...
def print_summary(rows):
    ...
    print("\nCIFAR-10 RESNET ENERGY SWEEP SUMMARY")
...
def save_summary(rows):
    ...
    print(f"\nsaved CIFAR-10 ResNet Energy sweep summary: {OUT_PATH}")
...
def main():
    ...
    for beta in BETAS:
        ...
        name = f"cifar_resnet20_kd_energy_T{value_to_name(BEST_KD_T)}_l{value_to_name(BEST_KD_LAMBDA)}_b{value_to_name(beta)}"
        ...
        print("\n" + "=" * 80)
        print(
            f"Running CIFAR-10 ResNet Energy sweep: "
