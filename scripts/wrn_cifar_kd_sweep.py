...
def save_summary(summary_rows):
    out_path = Path("results/cifar_wrn_kd_sweep_summary.csv")
    ...
    print(f"\nsaved WRN KD sweep summary: {out_path}")
...
def main():
    ...
    for T in TEMPERATURES:
        for lam in LAMBDAS:
            ...
            name = f"cifar_wrn16_2_kd_T{value_to_name(T)}_l{value_to_name(lam)}"
            ...
            print("\n" + "=" * 80)
            print(f"Running WRN KD sweep: T={T}, lambda={lam}")
            print("=" * 80)
