...
def make_row(
    ...
    return {
        ...
        "head_lr": train_stats.get("head_lr", ""),
        ...
        "head_loss_before": train_stats.get("head_loss_before", ""),
        "head_loss_after": train_stats.get("head_loss_after", ""),
        "head_loss_decrease": train_stats.get("head_loss_decrease", ""),
